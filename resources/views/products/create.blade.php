        ...
        <div class="grid-2">
            ...
            <div class="form-group">
                ...
                <div style="display:flex; gap:10px;">
                    <input type="text" name="sku" id="skuInput" class="form-control" value="{{ old('sku') }}" placeholder="PRD-001" required>
            ...
            <div class="form-group">
                ...
                <input type="text" name="unit" class="form-control" value="{{ old('unit', 'pcs') }}" placeholder="pcs / botol / kg" required>
            </div>
            <div class="form-group">
                <label class="form-label">Harga Jual (Rp) *</label>
                <input type="number" name="price" class="form-control" value="{{ old('price') }}" placeholder="15000" min="0" required>
                @error('price')<p class="text-sm text-red" style="margin-top:4px">{{ $message }}</p>@enderror
            </div>
            <div class="form-group">
                <label class="form-label">Harga Modal (Rp)</label>
                <input type="number" name="cost_price" class="form-control" value="{{ old('cost_price', 0) }}" placeholder="10000" min="0">
            </div>
            <div class="form-group">
...
<script>
    document.getElementById('categoryId').addEventListener('change', function() {
        // Only auto-generate if SKU is currently empty
